...
const projects = [
  {
    ...
    duration: "Jun 2025",
    description: `• Developed a full-stack mobile task manager using React Native (frontend) and Express.js (backend).
• Enabled users to add, edit, and delete tasks, with real-time sync via REST APIs.
• Integrated MongoDB for persistent storage and added token-based user authentication.`,
    techStack: ["React Native", "Express.js", "MongoDB", "REST API"],
  },
  {
  ...
  },
  {
    ...
    description: `• Developed a full-featured web app to manage clinical trials efficiently.
...
• Merged 3 apps into a single platform, improving user experience.`,
  ...
  },
  {
    ...
    company: "Smart IMS Pvt Ltd, Hyderabad",
    duration: "Dec 2022 - Sep 2024",
    description: `• Built EQMS to store/manage key documents during drug trials.
...
• Added custom role-based permissions and authentication.`,
  ...
  },
  {
    ...
    description: `• Designed and developed a responsive personal portfolio using React and Tailwind CSS.
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {projects.map((project, idx) => (
              ...
              >
                ...
                <p className="text-xs mb-3 text-gray-500 dark:text-gray-300">
                  {project.duration}
                </p>
